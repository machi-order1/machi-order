...
expect('更新キャッシュ番号', worker.includes("machi-order-v71-30"));
...
expect('勤怠・シフトをオフラインキャッシュ対象に追加', worker.includes("machi-order-v71-30") && worker.includes("'/time-clock.html'") && worker.includes("'/my-shifts.html'"));
