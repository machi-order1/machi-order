...
const [cashier, cashierApi, paymentUndo, reset, login, opening, operationLog, operationsApi, worker, menu, kitchen, kitchenManifest, shirakibaruKitchen, shirakibaruManifest, kitchenApps, productAdmin, menuAdminApi, menuApi, kitchenApi, orderingGuard, timeClock, myShifts, workforceApi, uiConfig, closing, closingApi, inventory, inventoryApi, systemCheck, offline, inventoryImport, inventoryParser, prep, prepMigration, staffOrder, staffOrderApi, machiApp] = await Promise.all([
  source('cashier.html'),
