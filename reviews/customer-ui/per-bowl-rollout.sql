-- Deployment draft; NOT applied to production.
-- Generate a migration with the Supabase CLI before integration.
-- Apply atomically before deploying menu-api / takeout-api and the customer UI.
begin;
